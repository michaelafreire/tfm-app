  ...
  en: {
    translation: {
      ...
      calibration: {
        ...
        continueSuggestion: "Your accuracy is 85% or higher, so you can continue when you are ready.",
  ...
  es: {
    translation: {
      ...
      calibration: {
        ...
        continueSuggestion: "Tu precisión es del 85 % o superior, así que puedes continuar cuando quieras.",
  ...
  ca: {
    translation: {
      ...
      calibration: {
        ...
        continueSuggestion: "La teva precisió és del 85 % o superior, així que pots continuar quan vulguis.",
