  ...
  en: {
    translation: {
      ...
      adaptive: {
        ...
        companionSubtitle: "Your companion will accompany you as you read and help you track your progress and milestones.",
      ...
      calibration: {
        ...
        accuracyMessage: "Calibration accuracy: {{accuracy}}%. Next step: {{experience}}.",
        accuracyNeedsRecalibration: "Your score is {{accuracy}}%, which is below 85%. Please recalibrate before continuing.",
        accuracyCanContinue: "Your score is {{accuracy}}%, so you can move forward. Click Continue.",
        recalibrateSuggestion: "We recommend recalibrating before you continue, because the target is 85% or higher.",
        continueSuggestion: "This is good enough to continue. You can recalibrate only if you want to try for a higher score.",
  ...
  es: {
    translation: {
      ...
      adaptive: {
        ...
        companionSubtitle: "Tu compañero te acompañará mientras lees y te ayudará a seguir tu progreso y tus avances de lectura.",
      ...
      calibration: {
        ...
        accuracyMessage: "Precisión de la calibración: {{accuracy}} %. Siguiente paso: {{experience}}.",
        accuracyNeedsRecalibration: "Tu puntuación es {{accuracy}} %, por debajo del 85 %. Por favor, recalibra antes de continuar.",
        accuracyCanContinue: "Tu puntuación es {{accuracy}} %, así que puedes avanzar. Haz clic en Continuar.",
        recalibrateSuggestion: "Recomendamos recalibrar antes de continuar, porque el objetivo es 85 % o más.",
        continueSuggestion: "Este resultado es suficiente para continuar. Recalibra solo si quieres intentar obtener una puntuación más alta.",
  ...
  ca: {
    translation: {
      ...
      adaptive: {
        ...
        companionSubtitle: "El teu company t’acompanyarà mentre llegeixes i t’ajudarà a seguir el teu progrés i els teus avenços de lectura.",
      ...
      calibration: {
        ...
        accuracyMessage: "Precisió de la calibració: {{accuracy}} %. Pas següent: {{experience}}.",
        accuracyNeedsRecalibration: "La teva puntuació és {{accuracy}} %, per sota del 85 %. Si us plau, recalibra abans de continuar.",
        accuracyCanContinue: "La teva puntuació és {{accuracy}} %, així que pots avançar. Fes clic a Continuar.",
        recalibrateSuggestion: "Recomanem recalibrar abans de continuar, perquè l'objectiu és 85 % o més.",
        continueSuggestion: "Aquest resultat és suficient per continuar. Recalibra només si vols intentar obtenir una puntuació més alta.",
...
En continuar, confirmes que has llegit i entès la informació anterior, que acceptes participar voluntàriament, que entens que l'ús de la càmera web només registra coordenades de mirada i no imatges ni vídeo, i que entens que l'ASRS no és una eina diagnòstica.`,
      ...
      post: {
        experience: {
          ...
          feedback: "Com, si és que en alguna cosa, el Company de Lectura va influir en la manera com et vas implicar en la tasca de lectura?",
        },
      },
      final:{
