...
function buildSuggestionPrompt(input: AfterReadingRequest) {
  return {
    ...
    rules: [
      ...
      "Keep the tone concise, friendly, and formative. Support the participant and avoid sounding judgmental.",
      ...
      "Start the message with a brief acknowledgment of finishing the previous reading and the effort put into it. Do not however say “Thank you“ something like “Great job finishing the reading!” as it can be perceived as patronizing, just acknowledge the effort in a neutral way.",
